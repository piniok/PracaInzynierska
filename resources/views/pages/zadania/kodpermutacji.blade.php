...
<title>Wyznaczanie kodu permutacji</title>
    ...
    @section('content')
       <div class="album text-muted">
		 ...
		 <div id = 'tresc' class="row text-center">
						<h1>Dla numeru permutacji {{$Nrp}} oraz jej rozmiaru S<sub>({{$s}})</sub> wyznacz permutację. </h1>
    	 </div>
		 <script>
...
btn.innerHTML = "<b> Skopiowano treść zadania! </b>";
		...
		<a href="/zadania/kodpermutacji" class="btn btn-primary  btn-primary " role="button"><b>Wygeneruj inne dane</b></a>  
		<button id = 'btn' class="btn btn-primary btn-primary " id="clickme" onclick=" CopyToClipboard()"><b>Kliknij aby skopiować treść zadania</b></button>       
    <div class="row">

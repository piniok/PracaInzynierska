...
<title>Wyznaczanie numeru permutacji</title>
...
btn.innerHTML = "<b> Skopiowano treść zadania! </b>";
		...
		<a href="/zadania/nrpermutacji" class="btn btn-primary  btn-primary " role="button"><b>Wygeneruj inne dane</b></a>   

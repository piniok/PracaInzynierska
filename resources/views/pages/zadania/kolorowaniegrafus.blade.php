...
<title>Kolorowanie wierzchołkowe grafów</title>
    ...
    @section('content')
       <div class="album text-muted">
		 ...
		 <div id='tresc' class="row text-center mt-3">
						<h2>Dla podanego grafu spójnego za pomocą poniższej metody wyznacz wielomian chromatyczny
                        ...
                        <br>Następnie za pomocą minimalnej liczby kolorów, należy pokolorować wierzchołki grafu w taki sposób, aby dwa sąsiednie wierzchołki nie były tego samego koloru 
						</h2>
						
</div>
	<div>	<img id='graf'alt="..." class="d-block img-center" src="{{$link}}">
		</div>	 
		<a href="/zadania/kolorowaniegrafus" class="btn btn-primary  btn-primary mt-3 " role="button"><b>Wygeneruj inne dane</b></a> 
